...
Purpose: Enable real-time credit risk monitoring
...
Limit new credit if utilization > 60%

Offer debt consolidation to Tier 2 borrowers

Deploy early warning system for repeat delays
